...
public class JavaDslTestCase {
	...
	public void testMonatlichFreiVerfügbarerBetrag1() throws CompilationFailedException, IOException {
		RealEstate realEstate = new RealEstate(true, new AmountWithCurrency(650.0, EURO_CURRENCY), 60.0);
		Applicant applicant = new Applicant(new AmountWithCurrency(1530.0, EURO_CURRENCY), realEstate);
	...
	public void testMietPruefung1() throws CompilationFailedException, IOException {
		RealEstate realEstate = new RealEstate(true, new AmountWithCurrency(430.0, EURO_CURRENCY), 60.0);
	...
	public void testMietPruefung2() throws CompilationFailedException, IOException {
		RealEstate realEstate = new RealEstate(true, new AmountWithCurrency(680.0, EURO_CURRENCY), 60.0);
